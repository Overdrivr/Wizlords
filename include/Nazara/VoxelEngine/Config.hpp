...
const unsigned int NAZARA_VOXELENGINE_CHUNKSIZE_X = 8;
const unsigned int NAZARA_VOXELENGINE_CHUNKSIZE_Y = 8;
const unsigned int NAZARA_VOXELENGINE_CHUNKSIZE_Z = 8;
